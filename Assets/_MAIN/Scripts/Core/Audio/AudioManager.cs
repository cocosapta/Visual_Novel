...
public class AudioManager : MonoBehaviour
{
    ...
    public AudioSource PlaySoundEffect(string filePath, AudioMixerGroup mixer = null, float volume = 1, float pitch = 1, bool loop = false)
    {
        ...
        return PlaySoundEffect(clip, mixer, pitch, volume, loop);
    }
    ...
    public AudioTrack PlayTrack(string filePath, int channel = 0, bool loop = false, float startingVolume = 0f, float volumeCap = 1f, float pitch = 1f)
    {
        AudioClip clip = Resources.Load<AudioClip>(filePath);
    ...
    public AudioTrack PlayTrack(AudioClip clip, int channel = 0, bool loop = false, float startingVolume = 0f, float volumeCap = 1f, float pitch = 1f, string filePath = "")
    {
